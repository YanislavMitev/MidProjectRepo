...
public class Demo {
	...
	public static void main(String[] args) throws IllegalPasswordException, IllegalEMailException, IllegalNameException {
		User ivan = new User("Ivan", "Ivanov", "ivan.ivanov@gmail.com", "ivanSexyPichagata69");
		User mivan = new User("MIvan", "MIvanov", "mivan.mivanov@gmail.com", "mivanSexyPichagata69");
	}
